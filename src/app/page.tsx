...
export default function Dashboard() {
  ...
  const tabs: { id: TabId; label: string; icon: React.ComponentType<{ className?: string }>; alert?: number }[] = [
    ...
    { id: "manufacturing", label: "Manufacturing", icon: Factory, alert: productionBlockers.length },
    { id: "inventory", label: "Inventory", icon: Package, alert: lowStock.length },
    { id: "procurement", label: "Procurement", icon: ShoppingCart },
  ]

  const quickLinks: { label: string; desc: string; href: string; icon: React.ComponentType<{ className?: string }>; accent: string }[] = [
    ...
    { label: "Inventory", desc: "Stock & valuation", href: "/components/inventory", icon: Package, accent: "text-primary bg-primary/10" },
    { label: "Production Planner", desc: "Schedule builds", href: "/production/planner", icon: Factory, accent: "text-primary bg-primary/10" },
    { label: "Purchase Requests", desc: "Raise & approve PRs", href: "/purchases/requests", icon: ShoppingCart, accent: "text-primary bg-primary/10" },
    ...
    { label: "Reports", desc: "Analytics & exports", href: "/reports", icon: BarChart2, accent: "text-primary bg-primary/10" },
  ]
