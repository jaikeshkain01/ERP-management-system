// ============================================================================
//  Selector factory — the SAME derivation logic, bound to any dataset.
//  `createSelectors(data)` powers both the mock store (src/mockdata/index.ts,
//  bound to the seed arrays) and the live backend store (src/lib/data-provider,
//  bound to /api/bootstrap). Pages consume these selectors identically in both
//  modes, so the UI works seamlessly on mockdata or the database.
// ============================================================================
import type {
  Component,
  Brand,
